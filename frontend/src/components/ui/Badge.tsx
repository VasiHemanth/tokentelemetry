...
export function AgentBadge({
  ...
  // Near-white brand marks (Grok, Pi, Qoder, ZCode) get a theme-aware tint so their
  // chip label and mark stay legible in light mode; the tinted background/border stay
