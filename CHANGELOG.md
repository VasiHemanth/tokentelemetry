...
- Codex: a session with a newer rollout file that fails partway through parsing no longer gets cached as complete using only the older file's data; it now stays a stub like a fully unreadable rollout does
