...
CACHE_VERSION = 13  # v2: added "loop" field; v3: added loop footprint_tokens/footprint_cost; v4: added published_artifacts; v5: page artifacts carry source path; v6: added "goals" (/goal); v7: Claude cached-read costs use cumulative usage and record untracked background activity; v8: Muse/Prime/Codex model metadata; v9: DeepSeek V4 repricing (#303) — cached sessions store a computed cost, so a rate change must invalidate them; v10: claude-sonnet-5 initial pricing set to $2/$10 (#250) — now date-banded (intro $2/$10 through 2026-08-31, standard $3/$15 from 2026-09-01); v11: assistant usage-dedupe fix restores continuation tool blocks; v12: Codex Sites are published artifacts; v13: delegated_by_model added to Claude cache payload for by_model analytics attribution
