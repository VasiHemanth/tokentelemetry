...
def test_claude_5_series_curated_pricing():
    ...
    _default. Sonnet 5 is a flat $2/$10: the increase to $3/$15 once scheduled
    for 2026-09-01 was cancelled and $2/$10 is now the standard rate, so there
    is deliberately no date band here."""
    ...
    # Same rate on either side of the cancelled cutover date.
    assert calculate_cost("claude-sonnet-5", MTOK, 0, 0, at="2026-08-15T12:00:00Z") == 2.00
    assert calculate_cost("claude-sonnet-5", MTOK, 0, 0, at="2026-09-07T12:00:00Z") == 2.00
