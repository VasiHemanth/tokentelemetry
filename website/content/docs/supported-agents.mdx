...
description: The 15 coding agents and Hermes autonomous agent that TokenTelemetry tracks, how each is detected, and what data each captures.
---
...
| **Prime Agent** | Prime Intelligence | `~/.prime/agent/sessions/` | tokens, traces, reported cost, model, active branch |
