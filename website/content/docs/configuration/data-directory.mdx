...
description: Move TokenTelemetry's config and state to a different directory using --data-dir, TOKENTELEMETRY_DATA_DIR, or TOKENTELEMETRY_HOME.
---
...
```bash
# Instance A
./start.sh --data-dir ~/tt-work --port 13000 --api-port 18000
