...
The frontend serves on host port **13000**; FastAPI is internal-only and reached through the frontend's same-origin proxy. The dashboard is therefore reachable from the same machine and nowhere else by default.
