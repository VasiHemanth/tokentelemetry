...
export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "TokenTelemetry auto-reads logs from Google Antigravity, OpenAI Codex CLI, Gemini CLI, Cursor, GitHub Copilot, Qwen CLI, OpenCode, Vibe, Grok Build, Cline, SmallCode, Pi, Meta Muse Code, and Prime Agent. Token counts and dollar costs appear in the local dashboard automatically when each agent records them.",
  },
  {
  ...
  },
  {
    ...
    a: "Fifteen coding agents (Claude Code, OpenAI Codex, Gemini CLI, Cursor, GitHub Copilot, Qwen CLI, OpenCode, Vibe, Antigravity, Grok Build, Cline, SmallCode, Pi, Meta Muse Code, and Prime Agent) plus Hermes Agent — Nous Research's autonomous agent, which gets its own dedicated dashboard at /hermes with gateway health, scheduled-job monitoring, skills + memory observability, and 38 source platforms (CLI / Telegram / Discord / Feishu / DingTalk / cron / webhook / …).",
  },
  {
